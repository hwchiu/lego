...
('GT',   'GlobalTech',        'GT',         'supplier',  'TW', 'SEMICON'),
...
-- GT
('GT','BBG','BBG000BD8ZK7','BBG_ID',1,'2020-01-01'),
('GT','BBG','9999 TT Equity','TICKER',0,'2020-01-01'),
('GT','FACTSET','0RIZ9D-E','FACTSET_ID',1,'2020-01-01'),
('GT','DNB','55-827-3199','DUNS',1,'2020-01-01'),
('GT','REFINITIV','4295895640','REFINITIV_ID',1,'2020-01-01'),
-- Samsung
...
('GT',    'BBG',      1, '0 6 * * 1-5', '2026-05-13 06:06:15'),
('GT',    'FACTSET',  1, '0 7 * * 1-5', '2026-05-13 07:08:02'),
('GT',    'REFINITIV',1, '0 7 * * 1-5', '2026-05-13 07:20:44'),
...
JOIN (VALUES
  ...
  -- GT+BBG
  ('GT','BBG','api_timeout_sec','30'),
  ('GT','BBG','rate_limit_per_min','60'),
  -- GT+REFINITIV
  ('GT','REFINITIV','api_timeout_sec','30'),
  ('GT','REFINITIV','rate_limit_per_min','90'),
  ('GT','REFINITIV','access_tier','STANDARD'),
  -- NVDA+BBG
...
-- GT
('GT','BBG_FINANCIALS',   1, NULL,            '2026-05-13 06:06:15'),
('GT','BBG_EQ_PRICE',     1, '0 8 * * 1-5',   '2026-05-14 08:04:33'),
('GT','FACTSET_FINS',     1, NULL,            '2026-05-13 07:08:02'),
('GT','REFIN_FINANCIALS', 1, NULL,            '2026-05-13 07:20:44'),
-- Samsung
...
JOIN (VALUES
  ...
  -- GT BBG_FINANCIALS (FY ends Dec = offset 0)
  ('GT','BBG_FINANCIALS','fiscal_year_offset','0'),
  ('GT','BBG_FINANCIALS','earnings_release_lag_days','60'),
  ('GT','BBG_FINANCIALS','report_currency','TWD'),
  ('GT','BBG_FINANCIALS','period_type','Q'),
  ('GT','BBG_FINANCIALS','accounting_standard','IFRS'),
  -- GT REFIN_FINANCIALS
  ('GT','REFIN_FINANCIALS','fiscal_year_offset','0'),
  ('GT','REFIN_FINANCIALS','earnings_release_lag_days','60'),
  ('GT','REFIN_FINANCIALS','report_currency','USD'),
