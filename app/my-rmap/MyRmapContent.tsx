...
function NetworkPreview1() {
  const nodes = [
    { x: 120, y: 80, r: 16, label: 'Intel', fill: '#1a2332' },
...
function NetworkPreview2() {
  const center = { x: 120, y: 30, label: 'INTC', r: 14 };
  const tier1 = [
...
function NetworkPreview3() {
  ...
  return (
    <svg viewBox="0 0 240 200" width="100%" style={{ display: 'block' }}>
      ...
      <text x={hub.x} y={hub.y + 1} textAnchor="middle" dominantBaseline="middle" fill="#fff" fontSize={7} fontWeight="700">Intel</text>
      {risks.map((r) => (
        <g key={r.label}>
...
const SCENARIO_CARDS = [
  {
    key: 'supplier',
    title: "Intel's Supplier Network",
    description: "Explore upstream supply relationships and tier-1/tier-2 supplier ecosystems for Intel.",
  ...
  {
    key: 'customer',
    title: "Intel's Customer Network",
    description: "Discover downstream customer relationships and distribution channels for Intel.",
  ...
  {
    key: 'competitor',
    title: "Intel's Competitor Network",
    description: "Map out competitive relationships and peer companies in the same market ecosystem as Intel.",
