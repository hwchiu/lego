...
function NetworkPreview1() {
  const nodes = [
    { x: 120, y: 80, r: 16, label: 'GlobalTech', fill: '#1a2332' },
...
function NetworkPreview2() {
  const center = { x: 120, y: 30, label: 'GT', r: 14 };
  const tier1 = [
...
function NetworkPreview3() {
  ...
  return (
    <svg viewBox="0 0 240 200" width="100%" style={{ display: 'block' }}>
      ...
      <text x={hub.x} y={hub.y + 1} textAnchor="middle" dominantBaseline="middle" fill="#fff" fontSize={7} fontWeight="700">GlobalTech</text>
      {risks.map((r) => (
        <g key={r.label}>
...
const SCENARIO_CARDS = [
  {
    key: 'supplier',
    title: "GlobalTech's Supplier Network",
    description: 'Explore upstream supply relationships and tier-1/tier-2 supplier ecosystems for GlobalTech.',
  ...
  {
    key: 'customer',
    title: "GlobalTech's Customer Network",
    description: 'Discover downstream customer relationships and distribution channels for GlobalTech.',
  ...
  {
    key: 'competitor',
    title: "GlobalTech's Competitor Network",
    description: 'Map out competitive relationships and peer companies in the same market ecosystem as GlobalTech.',
