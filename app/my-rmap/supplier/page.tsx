...
import SupplierGraph from '@/app/supply-chain-maps/supplier/SupplierGraph';
...
const tier1TotalRevenue = EDGE_ENTITIES.filter((e) => e.from === 'INTC').reduce(
...
export default function MyRmapSupplierPage() {
          ...
          <div className="page-pad scm-sub-page">
            ...
            <div className="rmap-company-header">
              ...
              <div className="rmap-company-header-info">
                ...
                <div className="rmap-company-header-full">Intel Corporation</div>
              </div>
            </div>
