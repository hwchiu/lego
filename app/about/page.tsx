...
const FEATURES = [
  ...
  },
  {
    ...
    desc: {
      zh: '以互動式視覺化圖譜呈現 GlobalTech 等龍頭企業的多層供應商網絡，支援 Tier 1 / Tier 2 關係追蹤、地緣風險標記與即時供應鏈新聞整合。',
      en: 'Visualizes multi-tier supplier networks of leading companies like GlobalTech with interactive maps, supporting Tier 1/Tier 2 tracking, geopolitical risk markers, and real-time supply chain news.',
    },
