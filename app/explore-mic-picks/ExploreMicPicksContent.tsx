...
function FabUtilizationChart() {
  ...
  const labels = ['leading foundry', '三星', '英特爾'];
  const W = 250,
    H = 90,
    barW = 16,
    barGap = 3,
          ...
          <div className="emp-policy-list">
            <div className="emp-policy-item">
              ...
              <div>
                ...
                <div className="emp-policy-desc">提供 527 億美元補貼，leading foundry亞利桑那廠已獲批 66 億美元直接資金。</div>
              </div>
            </div>
            <div className="emp-policy-item">
            ...
            <div className="emp-policy-item">
              ...
              <div>
                ...
                <div className="emp-policy-desc">補助leading foundry熊本廠建設，目標恢復日本先進晶圓製造能力。</div>
              </div>
            </div>
          </div>
        </div>
...
function Page3SupplyChain() {
  const milestones = [
    { company: 'leading foundry', node: '2nm (N2)', status: '量產', date: 'H2 2025' },
    { company: 'leading foundry', node: '1.4nm (A14)', status: '研發', date: '2027' },
  ...
  const segments: { iconNode: ReactNode; name: string; color: string; bg: string; points: string[] }[] = [
    {
      ...
      color: '#4fc3f7',
      bg: '#e0f2fe',
      points: ['輝達 H200/B200 需求超過供給 3–4 倍', 'CoWoS 封裝成為leading foundry主要增長引擎', 'AMD MI300 系列搶攻資料中心市占'],
    },
    {
      iconNode: <PhoneIcon />,
      name: '智能手機',
      ...
      <div className="emp-page-content">
        <div className="emp-market-chart-row">
          ...
          <div className="emp-insight-box emp-insight-box--green emp-insight-box--compact">
            ...
            <span>AI/HPC 年增 42% 成為leading foundry最強成長引擎，汽車電子 31% 增速緊隨其後，兩者合計佔先進製程新增需求的 65%。</span>
          </div>
        </div>
  ...
  const newTech = [
    {
      ...
      horizon: '量產中',
      color: '#4fc3f7',
      desc: '全繞閘場效電晶體，leading foundry N2 採用，提升效能/功耗比 15%',
    },
    {
      name: 'Chiplet / 異質整合',
      maturity: 85,
      ...
      <div className="emp-page-content emp-page-content--two-col">
        <div className="emp-col">
          ...
          <div className="emp-insight-box emp-insight-box--red emp-insight-box--compact">
            ...
            <span>leading foundry市占 61% 持續擴大，三星良率問題導致客戶回流，英特爾代工業務虧損壓力仍大。</span>
          </div>
...
function Page6CustomerSupplier() {
  const suppliers = [
    ...
    { name: 'Applied Materials', type: '設備', status: '穩定', risk: '中', color: '#fbbf24', desc: 'ALD/CVD 設備擴產，與leading foundry共同研發次世代製程' },
      ...
      <div className="emp-page-content emp-page-content--two-col">
        <div className="emp-col">
          ...
          <div className="emp-insight-box emp-insight-box--orange emp-insight-box--compact">
            ...
            <span>Apple Q4 業績超預期，iPhone 16 周期強勁；NVIDIA H200 產能全數由leading foundry CoWoS 供應。</span>
          </div>
          ...
          <div className="emp-capability-grid">
            {(() => {
              const capabilities: { iconNode: ReactNode; title: string; desc: string }[] = [
                ...
                { iconNode: <DiamondIcon />, title: '決策賦能', desc: '每份報告附帶「決策建議」區塊，直接對應leading foundry戰略場景。' },
