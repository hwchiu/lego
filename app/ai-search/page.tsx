...
const CAPABILITIES = [
  {
    ...
    desc: {
      zh: '用日常語言直接提問，例如「Intel 最近的供應鏈風險有哪些？」，AI 自動解析意圖並從海量資料中精準回答。',
      en: 'Ask questions in plain language — e.g., "What are the recent supply chain risks for Intel?" — and the AI parses your intent to deliver precise answers from massive datasets.',
    },
  },
  {
    icon: <SemanticIcon />,
              ...
              <div className="is-hero-content">
                ...
                <div className="is-mock-search">
                  ...
                  <span className="is-mock-search-placeholder">
                    {lang === 'zh' ? 'Intel 近期的供應鏈風險有哪些？' : "What are Intel's recent supply chain risks?"}
                  </span>
