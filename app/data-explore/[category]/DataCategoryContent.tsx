...
const CM_PRICE_LIMIT_ALL_COLUMNS: CmPriceVariationLimitColumn[] = [
  ...
  { id: 'single_order_volume_limit', labels: { zh: '單筆委託限制數量', en: 'Singal Order Volume Limit(Shares)' }, value: (row) => row.single_order_volume_limit, tableVisible: 'N', freezePane: 'N' },
  ...
  switch (tabId) {
    ...
    case 'price-limit': {
      ...
      const csvColumns: Array<{ labels: { zh: string; en: string }; getValue: (row: CmPriceVariationLimitRow) => string }> = [
        ...
        { labels: { zh: '單筆委託限制數量', en: 'Singal Order Volume Limit(Shares)' }, getValue: (row) => row.single_order_volume_limit },
