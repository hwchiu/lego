// GlobalTech global fab location data — used by Government Regulations world map
        ...
        fabs: [
          {
            id: 'fab2',
            name: 'Fab 2',
            description: 'One of GlobalTech\'s earliest fabs (former headquarters era). Produces mature specialty technologies and is primarily used for R&D and process qualification.',
            node: '1µm – 2µm',
            established: '1988',
          },
        ],
        ...
        fabs: [
          {
            id: 'fab21-p1',
            name: 'Fab 21 Phase 1',
            description: 'GlobalTech\'s first US fab (GlobalTech Arizona) in North Phoenix. Opened 2024. Produces N4 (4nm) chips primarily for Apple and AMD with $6.6B CHIPS Act support.',
            node: '4nm',
            established: '2024',
          },
          {
        ...
        fabs: [
          {
            ...
            description: 'Japan Advanced Semiconductor Manufacturing joint venture (GlobalTech 86.5%, Sony 9.5%, Denso 4%) in Kikuyo, Kumamoto. Opened Feb 2024. Produces automotive, IoT, and consumer chips.',
            node: '12nm – 40nm',
            established: '2024',
          },
          {
        ...
        fabs: [
          {
            ...
            description: 'European Semiconductor Manufacturing Company joint venture (GlobalTech 70%, Bosch 10%, Infineon 10%, NXP 10%) in Dresden. Targets automotive and industrial specialty chips supported by EU Chips Act funding.',
            node: '12nm – 28nm',
            established: '2027 (planned)',
          },
        ],
        ...
        fabs: [
          {
            id: 'fab16',
            name: 'Fab 16',
            description: 'GlobalTech\'s China 12-inch wafer fab in Nanjing. Produces N16 (16nm) chips and is expanding 28nm specialty capacity. Subject to US export control restrictions on advanced nodes.',
            node: '16nm – 28nm',
            established: '2018',
          },
        ],
