...
export const GRAPH_EDGES: GraphEdge[] = [
  ...
  { from: 'INTC', to: 'TSM', label: 'Foundry Competition', weight: 4, description: 'GlobalTech remains the benchmark competitor for Intel Foundry Services on leading-edge nodes.' },
