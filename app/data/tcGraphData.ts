...
export const GRAPH_EDGES: GraphEdge[] = [
  { from: 'TC', to: 'ASML', label: 'EUV System Procurement', weight: 5, description: "TSMC is ASML's largest customer; ~15 High-NA EUV tools on order for N2 node." },
  { from: 'TC', to: 'AMAT', label: 'CVD/PVD/CMP Tools', weight: 5, description: "Applied Materials supplies majority of TSMC's deposition and CMP equipment fleet." },
  { from: 'TC', to: 'LRCX', label: 'Etch Equipment', weight: 5, description: 'Lam Research etch tools are the primary platform for TSMC N3/N5 via-patterning.' },
  { from: 'TC', to: 'KLAC', label: 'Process Control & Inspection', weight: 4, description: 'KLA inspection tools deployed across all TSMC advanced node production lines.' },
  ...
  { from: 'TC', to: 'SHECY', label: 'Silicon Wafers & Photoresist', weight: 4, description: "Shin-Etsu is TSMC's primary 300mm polished silicon wafer supplier." },
  ...
  { from: 'TC', to: 'APD', label: 'Specialty Gases', weight: 3, description: 'Air Products delivers UHP NF3, WF6, and specialty gases to all TSMC fabs.' },
  ...
  { from: 'AAPL', to: 'TC', label: 'A/M-series Chips', weight: 5, description: 'Apple accounts for ~25% of TSMC revenue; A18/M4 chips on N3E.' },
  { from: 'QCOM', to: 'TC', label: 'Snapdragon SoCs', weight: 4, description: 'Qualcomm sources all Snapdragon 8-gen and X Elite chips at TSMC N4/N3.' },
  ...
  { from: 'AMD', to: 'TC', label: 'CPUs & AI GPUs', weight: 4, description: 'AMD sources Zen5 CPUs and MI300 GPUs at TSMC N5/N4P; ~$5B annual revenue.' },
  { from: 'META', to: 'TC', label: 'Custom AI Accelerators', weight: 3, description: 'Meta MTIA v2 inference chip manufactured at TSMC N3.' },
  { from: 'GOOGL', to: 'TC', label: 'TPU AI Chips', weight: 3, description: 'Google TPU v5/v6 AI training chips ordered at TSMC N5 and N3 nodes.' },
  { from: 'MSFT', to: 'TC', label: 'Maia AI Accelerators', weight: 3, description: 'Microsoft Azure Maia 100 AI accelerator chip manufactured at TSMC N5.' },
  { from: 'MRVL', to: 'TC', label: 'Custom AI Silicon', weight: 3, description: 'Marvell custom XPU AI accelerators for hyperscalers at TSMC N5/N3.' },
  { from: 'MTEKF', to: 'TC', label: 'Mobile SoCs', weight: 3, description: 'MediaTek Dimensity 9400 manufactured at TSMC N3E; ~$4B annual spending.' },
  { from: 'TC', to: 'AMKR', label: 'CoWoS Packaging', weight: 3, description: 'TSMC partners with Amkor for CoWoS-S back-end packaging for AI chips.' },
  { from: 'TC', to: 'ASX', label: 'SiP & 3D IC Packaging', weight: 3, description: 'ASE Group handles advanced SiP and fan-out WLP for TSMC customers.' },
  { from: 'TC', to: 'IBIDEN', label: 'Package Substrates', weight: 3, description: 'Ibiden ABF substrates are required for TSMC flip-chip packages on advanced nodes.' },
  { from: 'TC', to: 'SSNLF', label: 'Foundry Competition', weight: 4, description: 'Samsung Foundry competes directly with TSMC for AI chip orders at 3nm GAA node.' },
  { from: 'TC', to: 'INTC_F', label: 'IFS Competition', weight: 3, description: 'Intel Foundry Services (IFS) targets TSMC customers with Intel 18A process.' },
  { from: 'TC', to: 'GFS', label: 'Mature Node Competition', weight: 3, description: 'GlobalFoundries competes with TSMC in specialty and mature process nodes.' },
