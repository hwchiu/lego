...
const canvas3Cards: ContentCard[] = [
  {
    ...
    text:
      '2026 年 1 月初，美國與伊朗之間的外交緊張再度升溫，霍爾木茲海峽的通行安全引發全球供應鏈高度警戒。該海峽每日通過約 2,100 萬桶原油，佔全球海運原油供應的近 21%。伊朗已發出警告，若衝突升級，不排除封鎖海峽。對半導體產業而言，特殊製程氣體（氖氣、氪氣）及稀土元素的替代供應鏈尚不成熟，短期內料將面臨嚴峻壓力。全球科技已啟動緊急庫存盤點，並加速與日本、歐洲供應商的備援協議洽商。',
...
const canvas1Tasks: Task[] = [
  ...
  {
    id: 't1-2',
    title: '確認全球科技在 iPhone 供應鏈中佔比與未來展望',
    status: 'todo',
    assignee: m2,
    due: '2026-02-15',
    priority: 'medium',
...
const canvas3Tasks: Task[] = [
  {
    id: 't3-1',
    title: '評估全球科技特殊氣體庫存水位（目前存量可支撐幾週）',
    status: 'in-progress',
    assignee: m5,
    due: '2026-01-25',
    priority: 'high',
