...
export const MOCK_SEARCH_RESULTS: SearchResultItem[] = [
  ...
  // ── Events ─────────────────────────────────────────────────────────────────
  {
    ...
    company_name: '台灣積體電路製造股份有限公司',
    company_short_name: '台積電',
    title: '台積電 2024 年度技術論壇',
    content: '台積電將於 2024 年 3 月舉辦年度技術論壇，展示最新先進製程與封裝技術進展。',
    datetime: '2024-03-15T09:00:00Z',
    category: '法說會',
    url: 'https://example.com/tsmc-tech-forum-2024',
    source: '台積電官網',
  ...
  },
  {
    ...
    company_name: '台灣積體電路製造股份有限公司',
    company_short_name: '台積電',
    title: '台積電 Q3 2023 法人說明會',
    content: '台積電將於 2023 年 10 月舉辦第三季法人說明會，說明當季財務表現與未來展望。',
    datetime: '2023-10-19T08:00:00Z',
    category: '法說會',
    url: 'https://example.com/tsmc-q3-2023-earnings-call',
    source: '台積電投資人關係',
  ...
  // ── News ───────────────────────────────────────────────────────────────────
  {
    ...
    company_name: '台灣積體電路製造股份有限公司',
    company_short_name: '台積電',
    title: '台積電創新技術論壇登場，揭示未來半導體發展藍圖',
    content: '台積電於今日舉行年度創新技術論壇，正式揭示 2nm 及以下製程的最新研發進展，並展示 CoWoS 先進封裝量產進度。',
    datetime: '2023-10-26T10:00:00Z',
    category: '科技新聞',
    url: 'https://example.com/tsmc-tech-forum-news-123',
    source: '經濟日報',
    id: 'news_tsmc_20231026_001',
  },
  {
    doc_type: 'news',
    co_cd: 'NVDA',
  ...
  },
  {
    ...
    company_name: '台灣積體電路製造股份有限公司',
    company_short_name: '台積電',
    title: '台積電 2nm 製程量產時程確認，預計 2025 年下半年導入',
    content: '台積電確認 2nm 製程 (N2) 將於 2025 年下半年進入量產，首批客戶包括 Apple 及 NVIDIA。',
    datetime: '2024-02-20T08:30:00Z',
    category: '科技新聞',
    url: 'https://example.com/tsmc-2nm-production-timeline',
    source: '電子時報',
  ...
  },
  {
    ...
    company_name: '台灣積體電路製造股份有限公司',
    company_short_name: '台積電',
    title: '台積電亞利桑那廠首批晶片出爐，美國製造迎里程碑',
    content: '台積電位於美國亞利桑那州鳳凰城的晶圓廠成功生產首批 4nm 晶片，標誌美國先進半導體製造新頁。',
    datetime: '2024-04-23T15:00:00Z',
    category: '公司動態',
    url: 'https://example.com/tsmc-arizona-first-chips',
    source: '彭博社',
