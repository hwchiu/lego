...
export const MOCK_SEARCH_RESULTS: SearchResultItem[] = [
  // ── Companies ──────────────────────────────────────────────────────────────
  {
    doc_type: 'company',
    co_cd: 'TC',
    company_name: 'GlobalTech Semiconductor Co., Ltd.',
    company_short_name: 'GlobalTech',
    title: '',
    content: '',
    datetime: '',
    category: '',
  ...
  // ── Events ─────────────────────────────────────────────────────────────────
  {
    ...
    company_name: 'GlobalTech Semiconductor Co., Ltd.',
    company_short_name: 'GlobalTech',
    title: 'GlobalTech 2024 年度技術論壇',
    content: 'GlobalTech將於 2024 年 3 月舉辦年度技術論壇，展示最新先進製程與封裝技術進展。',
  ...
  },
  {
    ...
    company_name: 'GlobalTech Semiconductor Co., Ltd.',
    company_short_name: 'GlobalTech',
    title: 'GlobalTech Q3 2023 法人說明會',
    content: 'GlobalTech將於 2023 年 10 月舉辦第三季法人說明會，說明當季財務表現與未來展望。',
    datetime: '2023-10-19T08:00:00Z',
    category: '法說會',
    url: 'https://example.com/globaltech-q3-2023-earnings-call',
    source: 'GlobalTech投資人關係',
  ...
  // ── News ───────────────────────────────────────────────────────────────────
  {
    ...
    company_name: 'GlobalTech Semiconductor Co., Ltd.',
    company_short_name: 'GlobalTech',
    title: 'GlobalTech創新技術論壇登場，揭示未來半導體發展藍圖',
    content: 'GlobalTech於今日舉行年度創新技術論壇，正式揭示 2nm 及以下製程的最新研發進展，並展示 CoWoS 先進封裝量產進度。',
    datetime: '2023-10-26T10:00:00Z',
    category: '科技新聞',
    url: 'https://example.com/globaltech-tech-forum-news-123',
    source: '經濟日報',
    id: 'news_globaltech_20231026_001',
  },
  {
    doc_type: 'news',
    co_cd: 'NVDA',
  ...
  },
  {
    ...
    company_name: 'GlobalTech Semiconductor Co., Ltd.',
    company_short_name: 'GlobalTech',
    title: 'GlobalTech 2nm 製程量產時程確認，預計 2025 年下半年導入',
    content: 'GlobalTech確認 2nm 製程 (N2) 將於 2025 年下半年進入量產，首批客戶包括 Apple 及 NVIDIA。',
  ...
  },
  {
    ...
    company_name: 'GlobalTech Semiconductor Co., Ltd.',
    company_short_name: 'GlobalTech',
    title: 'GlobalTech亞利桑那廠首批晶片出爐，美國製造迎里程碑',
    content: 'GlobalTech位於美國亞利桑那州鳳凰城的晶圓廠成功生產首批 4nm 晶片，標誌美國先進半導體製造新頁。',
