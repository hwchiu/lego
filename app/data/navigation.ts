export interface NavItem {
  ...
  external?: boolean; // when true, opens href in a new tab
  subItems?: SubNavItem[];
}
...
export const sidebarIcons: Record<string, string> = {
  ...
  // Product Roadmap — milestone/timeline path icon
  productRoadmap:
    '<path d="M1.5 7h11" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/><circle cx="4" cy="7" r="1.5" stroke="currentColor" stroke-width="1.2" fill="none"/><circle cx="7" cy="4" r="1.5" stroke="currentColor" stroke-width="1.2" fill="none"/><circle cx="10" cy="10" r="1.5" stroke="currentColor" stroke-width="1.2" fill="none"/><path d="M4 7V4M7 4V7M10 7v3" stroke="currentColor" stroke-width="1.1" stroke-linecap="round"/>',
...
export const quickLinks: NavItem[] = [
  ...
  { label: 'Explore MIC Picks', href: '/explore-mic-picks', icon: 'star', badge: 'NEW', badgeStyle: 'new' },
...
export const bottomLinks: NavItem[] = [
  ...
  { label: 'Product Roadmap', href: '/product-roadmap', icon: 'productRoadmap' },
