...
export const bottomLinks: NavItem[] = [
  ...
  { label: 'User Manual', href: 'https://intranet.globaltech-example.com/pages/Uw5xaVFEXr', icon: 'userManual', external: true },
  { label: 'Product Roadmap', href: 'https://intranet.globaltech-example.com/pages/UMfqhC2Hp4', icon: 'productRoadmap', external: true },
