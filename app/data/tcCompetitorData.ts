...
export const INTEL_COMPETITORS: CompetitorNode[] = [
  {
    ...
    color: '#ed1c24',
    marketShare: 39.9,
    processNodes: ['Zen 5', 'TSMC N4', 'TSMC N3', 'CDNA 3'],
  ...
  },
  {
    ...
    color: '#76b900',
    marketShare: 18.5,
    processNodes: ['Blackwell', 'Grace', 'TSMC 4N', 'HBM3e'],
...
export const MARKET_SHARE_DATA: MarketShareEntry[] = [
  ...
  { id: 'TSM', name: 'TSMC', marketShare: 6.8 },
...
export const COMPETITOR_FEED: CompetitorFeedItem[] = [
  ...
  {
    id: 4,
    title: 'TSMC 2nm Timetable Becomes Key Benchmark for Intel Foundry Services 18A Ambitions',
    tickers: ['INTC', 'TSM'],
  ...
  {
    id: 10,
    title: 'Intel 18A Milestones Remain Central to Investor Debate Versus TSMC and Samsung',
