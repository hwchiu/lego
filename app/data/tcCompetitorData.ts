...
export const INTEL_COMPETITORS: CompetitorNode[] = [
  {
    ...
    color: '#ed1c24',
    marketShare: 39.9,
    processNodes: ['Zen 5', 'N4-class', 'N3-class', 'CDNA 3'],
  ...
  },
  {
    ...
    color: '#76b900',
    marketShare: 18.5,
    processNodes: ['Blackwell', 'Grace', '4N-class', 'HBM3e'],
...
export const COMPETITOR_FEED: CompetitorFeedItem[] = [
  ...
  {
    id: 4,
    title: '2nm Timetable Becomes a Key Benchmark for Intel Foundry Services 18A Ambitions',
    tickers: ['INTC'],
  ...
  {
    id: 10,
    title: 'Intel 18A Milestones Remain Central to Investor Debate Versus Samsung',
    tickers: ['INTC', 'SSNLF'],
    source: 'CNBC',
