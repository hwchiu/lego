...
export const MARKET_SHARE_DATA: MarketShareEntry[] = [
  { id: 'GT', name: 'GlobalTech', marketShare: 62.3 },
...
export const COMPETITOR_FEED: CompetitorFeedItem[] = [
  ...
  {
    id: 4,
    title: 'Intel Foundry 18A Process Enters Risk Production — CEO Eyes GlobalTech Customers',
    tickers: ['INTC_F', 'GT'],
    source: 'The Register',
