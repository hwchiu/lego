...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    color: '#2563eb',
    description:
      'Regulatory frameworks, export controls, semiconductor subsidies, and trade policies affecting GlobalTech and the broader semiconductor supply chain — including US CHIPS Act, BIS rules, and allied nation policies.',
  ...
  },
  {
    ...
    color: '#be123c',
    description:
      'Investment analysis, analyst ratings, price targets, institutional ownership, and capital market events for GlobalTech (TC ADR) and associated semiconductor sector equities.',
