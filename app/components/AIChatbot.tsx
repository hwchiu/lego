...
const AI_PRESET_QUESTION_ZH = 'GlobalTech 近期的供應鏈風險有哪些？';
const AI_PRESET_QUESTION_EN = "What are GlobalTech's recent supply chain risks?";
