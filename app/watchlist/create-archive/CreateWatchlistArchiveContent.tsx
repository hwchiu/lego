...
const AI_SUGGESTIONS: SuggestionItem[] = [
  ...
  },
  {
    ...
    type: 'event',
    symbols: ['AAPL', 'QCOM', 'AVGO', 'AMAT', 'LRCX', 'INTC', 'TXN', 'MU', 'KLAC'],
  },
  {
  ...
  },
  {
    ...
    type: 'topic',
    symbols: ['NVDA', 'INTC', 'AMD', 'QCOM', 'ASML', 'AMAT', 'LRCX', 'KLAC', 'MU', 'AVGO', 'TXN'],
  },
  {
    id: 'topic-3d-fabric',
    label: '3D Fabric',
    type: 'topic',
    symbols: ['NVDA', 'AMD', 'INTC', 'MU', 'AMKR', 'ASX', 'SMCI', 'AMAT', 'ENTG'],
  },
  {
    id: 'topic-reciprocal-tariff',
    label: 'US Reciprocal Tariff Policy',
    type: 'topic',
    symbols: ['AAPL', 'MSFT', 'AMZN', 'TSLA', 'NKE', 'WMT', 'COST', 'TGT', 'QCOM'],
  },
];
...
const AI_CONTEXT: Record<string, SuggestionAiContext> = {
  ...
  'event-taiwan-us-trade': {
    ...
    keyFactors: [
      ...
      'leading foundry Arizona fab 2nm production timeline pull-forward',
    ...
    symbolInfo: {
      AAPL: { tier: 'Primary', relevanceScore: 90, posKpis: ['A-series Chip Cost ↓', 'US-sourced Silicon % ↑', 'Supply Chain Resilience ↑', 'Gross Margin from Chips ↑'], note: '100% of A-series & M-series chips fabbed at leading foundry' },
      QCOM: { tier: 'Primary', relevanceScore: 88, posKpis: ['Snapdragon Margin ↑', 'US-fab Premium Wafer Cost ↓', 'Auto Chip Revenue ↑', 'PC-Chip Design Wins ↑'], note: 'Qualcomm designs all SoCs at leading foundry; major beneficiary' },
      AVGO: { tier: 'Primary', relevanceScore: 86, posKpis: ['Custom Silicon ASICs ↑', 'AI Accelerator Revenue ↑', 'Networking Chip Margin ↑', 'Hyperscaler Custom Revenue'], note: 'XPU + networking silicon at leading foundry advanced nodes' },
      AMAT: { tier: 'Secondary', relevanceScore: 83, posKpis: ['WFE Equipment Spend ↑', 'Etch & Deposition Tools ↑', 'Service Revenue ↑', 'Advanced Node Mix ↑'], note: 'leading foundry Arizona expansion drives ALD/CVD tool orders' },
  ...
  'topic-3d-fabric': {
    ...
    keyFactors: [
      'CoWoS substrate bottleneck being resolved with leading foundry CoWoS-S/L',
