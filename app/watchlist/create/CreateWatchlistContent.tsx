...
const AI_CONTEXT: Record<string, SuggestionAiContext> = {
  ...
  'event-taiwan-us-trade': {
    ...
    symbolInfo: {
      TSM:  { tier: 'Primary', relevanceScore: 97, posKpis: ['Arizona Fab Utilization ↑', 'US Advanced Node Revenue ↑', 'N3E Customer Wins ↑', 'CHIPS Act Subsidy'], note: 'Direct beneficiary as the world\'s leading contract foundry' },
  ...
  'topic-semiconductors': {
    ...
    symbolInfo: {
      ...
      TSM:  { tier: 'Primary', relevanceScore: 97, posKpis: ['Advanced Node Loading ↑', 'N3/N2 Revenue ↑', 'CoWoS Capacity ↑', 'Customer Diversification'], note: 'World leader in logic foundry; 60%+ advanced node share' },
  ...
  'topic-3d-fabric': {
    ...
    symbolInfo: {
      TSM:  { tier: 'Primary', relevanceScore: 98, posKpis: ['CoWoS Capacity Revenue ↑', 'SoIC 3D Stacking Wins ↑', 'Advanced Packaging % ↑', 'N3 + CoWoS Bundle Revenue'], note: 'TSMC CoWoS is the critical bottleneck input for AI GPUs' },
  ...
  'topic-reciprocal-tariff': {
    ...
    symbolInfo: {
      ...
      TSM:  { tier: 'Primary', relevanceScore: 86, posKpis: ['Arizona Fab US Revenue ↑', 'Tariff-exempt US Production ↑', 'CHIPS Act Subsidy ↑', 'US Customer Priority Access'], note: 'TSMC Arizona enables US-fabricated chips exempt from tariffs' },
