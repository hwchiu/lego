      ...
      <div className="rmap-node-info-card-body">
        ...
        {!isCenter && (
          <p className="rmap-detail-items" style={{ marginTop: 8 }}>
            <span className="rmap-detail-label">Products from Intel: </span>
            {node.purchaseItems}
          </p>
        )}
        {edge && (
  ...
  return (
    <div className="rmap-supplier-table-wrap">
      <div className="rmap-supplier-table-section">
        <div className="rmap-supplier-table-title">Intel Customers</div>
        <table className="rmap-supplier-table">
          <thead>
            <tr>
              ...
              <th className="rmap-supplier-th">Products from Intel</th>
      ...
      <div className="rmap-graph-content">
        <div className="rmap-svg-container">
          <svg
            ...
            viewBox={vbStr}
            className="rmap-svg"
            aria-label="Intel Customer Relationship Graph"
