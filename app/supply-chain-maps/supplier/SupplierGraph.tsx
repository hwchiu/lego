...
const SUPPLY_CHAIN_FEED: FeedItem[] = [
  {
    id: 1,
    title: 'ASML Confirms EUV Machine Deliveries to Intel On Track for Intel 18A Node',
    tickers: ['ASML', 'INTC'],
    source: 'Reuters',
    time: 'Today, 9:15 AM',
  },
  ...
  {
    id: 3,
    title: 'Lam Research Expands ALD Capacity to Meet Intel Intel 18A Production Demand',
    tickers: ['LRCX', 'INTC'],
  ...
  {
    id: 4,
    title: 'Intel Q1 2025: Supplier Risk Assessment — Geopolitical Tensions in Focus',
    tickers: ['INTC', 'ASML'],
    source: 'SA News',
  ...
  {
    id: 5,
    title: 'KLA Corp Upgrades Process Control Tools for Intel Advanced Packaging Lines',
    tickers: ['KLAC', 'INTC'],
    source: 'Zacks',
    time: 'Apr 2, 3:00 PM',
  },
  {
    id: 6,
    title: 'US Export Restrictions Could Affect ASML EUV Shipments for Advanced Fabs',
    tickers: ['ASML', 'INTC'],
  ...
  {
    id: 7,
    title: 'Shin-Etsu Chemical Raises Silicon Wafer Prices Ahead of Intel Capacity Expansion',
    tickers: ['SHECY', 'INTC'],
    source: 'Nikkei',
    time: 'Apr 1, 9:30 AM',
  },
  {
    id: 8,
    title: 'Air Products Signs 10-Year UHP Gas Supply Agreement with Intel Arizona Fab',
    tickers: ['APD', 'INTC'],
    source: 'PR Newswire',
    time: 'Mar 31, 2:00 PM',
  },
  {
    id: 9,
    title: 'Entegris Launches Next-Gen CMP Slurry Optimized for Intel 18A Process Node',
    tickers: ['ENTG', 'INTC'],
  ...
  {
    id: 10,
    title: 'Tokyo Electron Wins Major Intel Order for Thermal CVD Equipment Fleet',
    tickers: ['TOELY', 'INTC'],
    source: 'Nikkei Asia',
    time: 'Mar 30, 8:00 AM',
  },
      ...
      <div className="rmap-graph-content">
        ...
        <div className="rmap-svg-container">
          <svg
            ...
            viewBox={vbStr}
            className="rmap-svg"
            aria-label="Intel Supplier Relationship Graph"
