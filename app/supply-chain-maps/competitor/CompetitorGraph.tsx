...
function FilterBar({
  ...
  const companyResults = [
    ...competitorMatches,
    ...masterMatches.filter((c) => !competitorTickers.has(c.sub)),
  ].slice(0, 3);
  ...
  return (
    <div className="rmap-supplier-table-wrap">
      <div className="rmap-supplier-table-section">
        <div className="rmap-supplier-table-title">GlobalTech Competitors by Market Share</div>
      ...
      <div className="rmap-graph-content">
        <div className="rmap-svg-container">
          <svg
            ...
            viewBox={vbStr}
            className="rmap-svg"
            aria-label="GlobalTech Competitor Relationship Graph"
